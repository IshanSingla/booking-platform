                            ...
                            <div className="flex items-center space-x-4 lg:col-span-2">
                                <div className="space-y-2">
                                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl flex items-start">
                                        ...
                                        {data?.isVerified && 
                                            <span title="Verified">
                                                <svg width="28" height="28" viewBox="0 0 16 16" aria-label="Verified Partner"><path fill-rule="evenodd" d="M12.5 3.5 8 2 3.5 3.5 2 8l1.5 4.5L8 14l4.5-1.5L14 8l-1.5-4.5ZM7 11l4.5-4.5L10 5 7 8 5.5 6.5 4 8l3 3Z" clip-rule="evenodd"></path></svg>
                                            </span>
                                        }
                                    </h1>
                            ...
                            <div className="grid gap-6 lg:grid-cols-1 lg:items-start lg:gap-4 ">
                                <div className="space-y-2">
                                    ...
                                    <div className='flex gap-2'>
                                        {!data?.isVerified &&
                                            <Button className='hover:text-gray-100 hover:bg-[#307672] border-[1px] border-solid border-black'>Verfiy Profile</Button>
                                        }
                                        <Dialog>
                                            <DialogTrigger className='p-2 !rounded-md hover:text-gray-100 hover:bg-[#307672] border-[1px] border-solid border-black'>Edit Profile</DialogTrigger>
